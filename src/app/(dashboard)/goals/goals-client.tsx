                ...
                <CardContent className="pt-5">
                  ...
                  {addingTo === g.id ? (
                    <div className="flex gap-2">
                      ...
                      />
                      <button onClick={() => handleAddFunds(g.id)} disabled={pending} className="px-4 py-2 rounded-lg bg-success text-white text-sm font-medium hover:bg-success/90 disabled:opacity-60 transition-colors">
                        +
                      </button>
                      <button onClick={() => { setAddingTo(null); setAddAmount(""); }} className="px-3 py-2 rounded-lg border text-sm hover:bg-accent transition-colors">
                        ✕
                      </button>
                    </div>
                  ) : (
                ...
                <div className="flex flex-wrap gap-2">
                  {GOAL_ICONS.map((icon) => (
                    <label key={icon} className="cursor-pointer">
                      ...
                      <span className="text-2xl p-2 rounded-lg peer-checked:bg-primary/20 hover:bg-accent transition-colors block">
                        {icon}
                      </span>
                    </label>
                  ))}
